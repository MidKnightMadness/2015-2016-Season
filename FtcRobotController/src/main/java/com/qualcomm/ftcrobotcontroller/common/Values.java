...
public class Values {
    ...
    public static final int PLOW_DEPLOY = 2600; // was 2500
...
//    public static final double TRIGGER_RIGHT_RETRACT = 0.23137255;
    ...
    public static final double TRIGGER_LEFT_DEPLOY = 1;
    public static final double TRIGGER_LEFT_RETRACT = 0.105882354;

    public static final double TRIGGER_RIGHT_DEPLOY = 0.23137255;
    public static final double TRIGGER_RIGHT_RETRACT = 1;
}
